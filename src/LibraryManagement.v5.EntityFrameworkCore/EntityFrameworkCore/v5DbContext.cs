...
public class v5DbContext :
    AbpDbContext<v5DbContext>,
    ...
    IIdentityDbContext
{
    ...
    public v5DbContext(DbContextOptions<v5DbContext> options)
        : base(options)
    {
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        {
            b.ToTable(v5Consts.DbTablePrefix + "Books", v5Consts.DbSchema);
        ...
        {
            b.ToTable(v5Consts.DbTablePrefix + "Authors",
                v5Consts.DbSchema);
        ...
        //{
        //    b.ToTable(v5Consts.DbTablePrefix + "YourEntities", v5Consts.DbSchema);
        //    b.ConfigureByConvention(); //auto configure for the base class props
        //    //...
        //});
    }
